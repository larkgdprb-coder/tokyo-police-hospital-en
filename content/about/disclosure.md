...
◇ Regarding notifications related to facility standards for basic medical fees For notifications related to our hospital's basic medical fees, please see the bulletin board at the front entrance [List of facility standards notifications (as of July 1, 2020)].
...
Our hospital has established a collaborative system with the following insurance medical institutions that provide dental treatment, and we work together to ensure that inpatients with oral health issues can receive dental treatment. "Okubo Dental Clinic", "Murayama Dental Clinic", "Fujimidai Sakura Dental Clinic", "Fujii Dental Clinic", "Masami Dental Clinic", "KUMA Dental Clinic", "Hayashi Dental Clinic", "Yokoyama Dental Clinic", "Dental Nakai Clinic", "Momoen Dori Murakami Dental Clinic", "Rivals Dental Clinic", "Kobayashi Dental Clinic"
...
◇ Regarding notifications related to facility standards for specially listed medical fees For notifications related to our hospital's specially listed medical fees, please see the attached [List of facility standards notifications (as of July 1, 2020)].
